        ...
        {!loading && user && (
          <div className="min-h-screen flex justify-center p-8">
            <div className="w-full max-w-7xl relative">
              ...
              {/* Main Content Grid */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-32 lg:mt-0">
                ...
                <div className="flex flex-col items-center lg:items-start">
                  <div className="relative w-80 h-96 lg:w-96 lg:h-[500px]">
                    ...
                    <div className="flex gap-4 mt-10 mb-10 justify-center lg:justify-start">
